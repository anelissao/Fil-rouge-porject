...
@section('title', 'Student Evaluation View')
...
<div class="container mx-auto px-4 py-6">
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Student Evaluation View</h1>
                <p class="mt-2 text-gray-600">
                    @if($isEvaluator)
                        View as {{ $evaluation->evaluator->username }} (Evaluator)
                    @else
                        View as {{ $evaluation->submission->student->username }} (Student Being Evaluated)
                    @endif
                </p>
            </div>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden mb-6">
        <div class="border-b border-gray-200 bg-gray-50 px-6 py-4 flex justify-between items-center">
            <h2 class="text-lg font-medium text-gray-900">Submission Preview</h2>
                ...
                <form action="{{ route('teacher.evaluations.reassign', $evaluation->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="new_evaluator_id" name="new_evaluator_id" required class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                            ...
                            <!-- You'll need to pass $students to this view and loop through them here -->
                        </select>
                    </div>
